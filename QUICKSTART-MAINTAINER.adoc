...
// Replace tlaiser, tlaiser, {{DEPS}} with actuals
...
| `$PREFIX/share/tlaiser/`
| Data files, assets

| `$PREFIX/share/doc/tlaiser/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/tlaiser/config.toml`

Fallback: `$HOME/.config/tlaiser/config.toml`
...
Or via OPSM: `opsm update tlaiser`
...
[source,bash]
----
just install --prefix=/opt/tlaiser-instance1 --config=/etc/tlaiser/instance1.toml
just install --prefix=/opt/tlaiser-instance2 --config=/etc/tlaiser/instance2.toml
----
